...
import com.gouqi.make.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        // 校验并填充默认值
        String name = StrUtil.blankToDefault(meta.getName(), "generator");
        String description = StrUtil.emptyToDefault(meta.getDescription(), "模板代码生成器");
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "gouqi");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.gouqi");
