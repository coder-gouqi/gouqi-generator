...
import com.gouqi.make.meta.enums.FileGenerateTypeEnum;
import com.gouqi.make.meta.enums.FileTypeEnum;
import com.gouqi.make.model.FileFilterConfig;
import com.gouqi.make.model.TemplateMakerFileConfig;
import com.gouqi.make.model.TemplateMakerModelConfig;
import com.gouqi.make.template.enums.FileFilterRangeEnum;
import com.gouqi.make.template.enums.FileFilterRuleEnum;
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, templateMakerModelConfig, 1762815324237357056L);
    ...
    private static List<Meta.FileConfig.FileInfo> distinctFiles(List<Meta.FileConfig.FileInfo> fileInfoList) {
        ...
        for (Map.Entry<String, List<Meta.FileConfig.FileInfo>> entry : groupKeyFileInfoListMap.entrySet()) {
            ...
            List<Meta.FileConfig.FileInfo> newFileInfoList = new ArrayList<>(tempFileInfoList.stream().flatMap(fileInfo -> fileInfo.getFiles().stream()).collect(Collectors.toMap(Meta.FileConfig.FileInfo::getInputPath, o -> o, (e, r) -> r)).values());
