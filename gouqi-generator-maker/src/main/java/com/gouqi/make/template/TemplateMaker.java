...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath2 = "src/main/java/com/gouqi/controller";
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, modelInfo, searchStr, 1762815324237357056L);
