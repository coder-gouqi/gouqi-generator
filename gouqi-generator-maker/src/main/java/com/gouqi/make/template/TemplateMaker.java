...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String description = "ACM 模板生成器";

        // 2. 输入文件信息
        String projectPath = System.getProperty("user.dir");
        String sourceRootPath = new File(projectPath).getParent() + File.separator + "acm-template";
        // 注意 win 系统需要对路径进行转义
        sourceRootPath = sourceRootPath.replaceAll("\\\\", "/");

        String fileInputPath = "src/com/gouqi/acm/MainTemplate.java";
